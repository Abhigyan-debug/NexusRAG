    ...
    <div className="min-h-screen bg-nexus-bg text-nexus-text selection:bg-nexus-accent/30 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            ...
            >
              <h2 className="text-2xl font-display font-bold mb-4 text-nexus-heading">Our Goal</h2>
            ...
            <motion.div
              ...
              className="nexus-panel p-8"
            >
              <h2 className="text-2xl font-display font-bold mb-4 text-nexus-heading">Our Mission</h2>
              <p className="text-nexus-muted leading-relaxed">
          ...
          >
            <h2 className="text-3xl font-display font-bold mb-8 text-center text-nexus-heading">Technologies Used</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="nexus-panel p-6 flex flex-col items-center text-center group hover:border-nexus-accent/50 transition-all">
                  ...
                  <h3 className="font-semibold text-lg text-nexus-heading mb-1">{tech.label}</h3>
      ...
      <footer className="border-t border-nexus-border/50 py-12 mt-20 text-center">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="font-display font-bold text-lg text-nexus-heading">NexusRAG</span>
        </div>
